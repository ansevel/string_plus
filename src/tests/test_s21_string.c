...
START_TEST(test_s21_sprintf_x_point_width_and)
{
#line 736
    char str[100];
    char test_str[100];
...
int main(void)
{
    ...
    tcase_add_test(tc1_1, test_s21_sprintf_o_zero_point_with_sharp_and_width_and_plus);
    tcase_add_test(tc1_1, test_s21_sprintf_o_zero_point_with_sharp_and_width_and_minus);
    ...
    tcase_add_test(tc1_1, test_s21_sprintf_x_zero_point_with_sharp_and_width_and_plus);
    tcase_add_test(tc1_1, test_s21_sprintf_x_with_precision);
    tcase_add_test(tc1_1, test_s21_sprintf_x_point_width);
    tcase_add_test(tc1_1, test_s21_sprintf_x_point_width_and);
    tcase_add_test(tc1_1, test_s21_sprintf_p);
    tcase_add_test(tc1_1, test_s21_sprintf_positive_lf_with_zero_intend_and_round);
    ...
    tcase_add_test(tc1_1, test_s21_sprintf_positive__with_plus_lf_with_zero_intend_and_round);
    tcase_add_test(tc1_1, test_s21_sprintf_negative_lf_with_zero_intend_and_round);
